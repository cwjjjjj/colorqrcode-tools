          ...
          <div className="container mx-auto max-w-4xl">
            <div className="text-center mb-12 animate-fadeInUp">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass mb-6">
                ...
                <span className="text-sm font-medium text-gray-800">AI-Powered Tool</span>
              </div>

              <h2 className="text-5xl md:text-6xl font-bold mb-4 text-gray-800" style={{ letterSpacing: "-0.02em" }}>
                AI Color Palette Generator
              </h2>
          ...
          <div className="container mx-auto max-w-4xl">
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="glass-card p-6 text-center animate-fadeInScale stagger-2">
                <div className="text-4xl mb-4">♿</div>
                <h3 className="text-lg font-bold mb-2 text-gray-800">Accessible</h3>
                <p className="text-gray-800/70 text-sm">
              ...
              <div className="glass-card p-6 text-center animate-fadeInScale stagger-3">
                <div className="text-4xl mb-4">🎨</div>
                <h3 className="text-lg font-bold mb-2 text-gray-800">Tailwind Ready</h3>
                <p className="text-gray-800/70 text-sm">
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto max-w-4xl">
            <div className="glass-card p-8 md:p-12 prose prose-invert max-w-none">
              <h2 className="text-3xl font-bold text-gray-800 mb-6">About AI Color Palette Generator</h2>
              ...
              <h3 className="text-2xl font-bold text-gray-800 mt-8 mb-4">Features</h3>
              ...
              <h3 className="text-2xl font-bold text-gray-800 mt-8 mb-4">How to Use</h3>
              <ol className="space-y-3 text-gray-800/80">
                <li className="flex items-start gap-3">
                  <span className="flex-shrink-0 w-6 h-6 rounded-full bg-gradient-to-br from-blue-500 to-purple-500 text-gray-800 text-sm flex items-center justify-center font-bold">1</span>
                  <span>Click "Generate" to create a new AI-generated color scheme</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="flex-shrink-0 w-6 h-6 rounded-full bg-gradient-to-br from-blue-500 to-purple-500 text-gray-800 text-sm flex items-center justify-center font-bold">2</span>
                  <span>Lock colors you like by clicking the lock icon</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="flex-shrink-0 w-6 h-6 rounded-full bg-gradient-to-br from-blue-500 to-purple-500 text-gray-800 text-sm flex items-center justify-center font-bold">3</span>
                  <span>Check accessibility ratings for color contrast</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="flex-shrink-0 w-6 h-6 rounded-full bg-gradient-to-br from-blue-500 to-purple-500 text-gray-800 text-sm flex items-center justify-center font-bold">4</span>
                  <span>Copy individual colors or export entire Tailwind config</span>
                </li>
              </ol>

              <h3 className="text-2xl font-bold text-gray-800 mt-8 mb-4">Color Theory Basics</h3>
              <p className="text-gray-800/80 leading-relaxed">
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto max-w-4xl">
            <div className="glass-card p-12 text-center">
              <h2 className="text-4xl font-bold mb-4 text-gray-800">Need More Design Tools?</h2>
